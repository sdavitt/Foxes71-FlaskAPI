...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('SQLALCHEMY_DATABASE_URI') # reminder: add 'ql' to the end of 'postgres' to make 'postgresql' in the database_uri in the .env file
